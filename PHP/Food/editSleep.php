  ...
  <body>
    <div class="container">
        ...
        <div class="page-header">
          <h1>Sleep <small>Record your daily sleep cycles</small></h1>
        </div>
        ...
        <form class="form-horizontal" action="" method="post" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="txtName" name="Name" placeholder="Style of Sleep" value="<?=$meal['Name']?>">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-group">
            <label class="col-sm-2 control-label" for="txtDate">When did you sleep</label>
            <div class="col-sm-10">
