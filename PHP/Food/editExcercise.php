  ...
  <body>
    <div class="container">
        ...
        <div class="page-header">
          <h1>Excercise <small>Record your daily workouts</small></h1>
        </div>
          <div class='alert alert-warning'>
            <button type="button" class="close" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
            <b>Special Offer</b> One Month Membership to Gym!
          </div> 
        <form class="form-horizontal" action="" method="post" >
          ...
          <div class="form-group">
            ...
            <div class="col-sm-10">
              <input type="text" class="form-control" id="txtName" name="Name" placeholder="Excercise Type" value="<?=$meal['Name']?>">
            </div>
          </div>
          <div class="form-group">
            <label class="col-sm-2 control-label" for="txtCallories">Callories</label>
            <div class="col-sm-10">
                  <input type="number" class="form-control" id="txtCallories" name="Callories" placeholder="Callories burned during Excercise"  value="<?=$meal['Callories']?>">
            </div>
          </div>
          <div class="form-group">
